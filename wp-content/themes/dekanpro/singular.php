...
<div class="dekanpro-container">
	...
	<div id="primary" class="content-area">
		...
		<main id="content" class="site-content <?php echo esc_attr( $class_no_media ); ?>" role="main"<?php dekanpro_schema_markup( 'main' ); ?>>

			<?php
			do_action( 'dekanpro_before_singular' );

			do_action( 'dekanpro_content_singular' );

			do_action( 'dekanpro_after_singular' );
			?>
