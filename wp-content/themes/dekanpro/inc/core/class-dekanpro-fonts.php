...
if ( ! class_exists( 'Dekanpro_Fonts' ) ) :

	/**
	 * Dekanpro helper class to handle fonts.
	 *
	 * @since 1.0.0
	 */
	class Dekanpro_Fonts {
		 ...
		 * @since 1.0.0
		 *
		 * @return Array All the system fonts in Dekanpro
		 */
		public function get_system_fonts() {
			...
			return apply_filters( 'dekanpro_system_fonts', $this->system_fonts );
		}
		...
		public function get_standard_fonts() {
			...
			return apply_filters( 'dekanpro_standard_fonts', $standard_fonts );
		}
		...
		public function get_default_system_font() {
			...
			return apply_filters( 'dekanpro_default_system_font', $font );
		}
		...
		public function get_google_fonts() {
			...
			if ( empty( $this->google_fonts ) ) {
				...
				$google_fonts_file = apply_filters( 'dekanpro_google_fonts_json_file', DEKANPRO_THEME_PATH . '/assets/fonts/google-fonts.json' );
			...
			return apply_filters( 'dekanpro_google_fonts', $this->google_fonts );
		}
		...
		public function get_google_font_subsets() {
			...
			$subsets = array(
				'arabic'              => esc_html__( 'Arabic', 'dekanpro' ),
				'bengali'             => esc_html__( 'Bengali', 'dekanpro' ),
				'chinese-hongkong'    => esc_html__( 'Chinese (Hong Kong)', 'dekanpro' ),
				'chinese-simplified'  => esc_html__( 'Chinese (Simplified)', 'dekanpro' ),
				'chinese-traditional' => esc_html__( 'Chinese (Traditional)', 'dekanpro' ),
				'cyrillic'            => esc_html__( 'Cyrillic', 'dekanpro' ),
				'cyrillic-ext'        => esc_html__( 'Cyrillic Extended', 'dekanpro' ),
				'devanagari'          => esc_html__( 'Devanagari', 'dekanpro' ),
				'greek'               => esc_html__( 'Greek', 'dekanpro' ),
				'greek-ext'           => esc_html__( 'Greek Extended', 'dekanpro' ),
				'gujarati'            => esc_html__( 'Gujarati', 'dekanpro' ),
				'gurmukhi'            => esc_html__( 'Gurmukhi', 'dekanpro' ),
				'hebrew'              => esc_html__( 'Hebrew', 'dekanpro' ),
				'japanese'            => esc_html__( 'Japanese', 'dekanpro' ),
				'kannada'             => esc_html__( 'Kannada', 'dekanpro' ),
				'khmer'               => esc_html__( 'Khmer', 'dekanpro' ),
				'korean'              => esc_html__( 'Korean', 'dekanpro' ),
				'latin'               => esc_html__( 'Latin', 'dekanpro' ),
				'latin-ext'           => esc_html__( 'Latin Extended', 'dekanpro' ),
				'malayalam'           => esc_html__( 'Malayalam', 'dekanpro' ),
				'myanmar'             => esc_html__( 'Myanmar', 'dekanpro' ),
				'oriya'               => esc_html__( 'Oriya', 'dekanpro' ),
				'sinhala'             => esc_html__( 'Sinhala', 'dekanpro' ),
				'tamil'               => esc_html__( 'Tamil', 'dekanpro' ),
				'telugu'              => esc_html__( 'Telugu', 'dekanpro' ),
				'thai'                => esc_html__( 'Thai', 'dekanpro' ),
				'vietnamese'          => esc_html__( 'Vietnamese', 'dekanpro' ),
			);

			return apply_filters( 'dekanpro_google_font_subsets', $subsets );
		}
		...
		public function get_backup_fonts() {
			...
			return apply_filters( 'dekanpro_backup_fonts', $backup_fonts );
		}
		...
		public function enqueue_google_fonts() {
			...
			$fonts = get_transient( 'dekanpro_google_fonts_enqueue' );
		...
		public function enqueue_google_font( $family, $args = array() ) {
			...
			set_transient( 'dekanpro_google_fonts_enqueue', $fonts );
		}
		...
		public function get_fonts() {
			...
			$fonts['standard_fonts'] = array(
				'name'  => esc_html__( 'Standard', 'dekanpro' ),
				'fonts' => self::get_standard_fonts(),
			);

			$fonts['system_fonts'] = array(
				'name'  => esc_html__( 'System Fonts', 'dekanpro' ),
				'fonts' => self::get_system_fonts(),
			);

			$fonts['google_fonts'] = array(
				'name'  => esc_html__( 'Google Fonts', 'dekanpro' ),
				'fonts' => self::get_google_fonts(),
			);

			return apply_filters( 'dekanpro_get_fonts', $fonts );
		}
		...
		public function get_font_family( $font ) {
			...
			return apply_filters( 'dekanpro_font_family', $font );
		}
	}
