;( function( $ ) {
	...
	var dekanproDependencies = {
		...
		init: function() {
			...
			wp.customize.control.each( function( control ) {
				self.showDekanproControl( control );
			});
					...
					wp.customize( master, function( setting ) {
						var setupControl = function( control ) {
							...
							isDisplayed = function() {
								return self.showDekanproControl( wp.customize.control( slave ) );
							};
		 ...
		 * @returns {bool}
		 */
		showDekanproControl: function( control ) {
			var self     = this,
				show     = true,
				i;
		 ...
		 *
		 * @since 1.0.0
		 * @param {Object} requirement - The requirement, inherited from showDekanproControl.
	...
	}; // END var dekanproDependencies

	$( document ).ready( function() {
		dekanproDependencies.init();
	});
