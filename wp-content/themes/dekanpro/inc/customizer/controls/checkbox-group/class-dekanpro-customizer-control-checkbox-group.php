...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Checkbox_Group' ) ) :
	/**
	 * Dekanpro Customizer checkbox group control class.
	 */
	class Dekanpro_Customizer_Control_Checkbox_Group extends Dekanpro_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'dekanpro-checkbox-group';
		...
		protected function content_template() {
			?>
			<div class="dekanpro-checkbox-group-wrapper dekanpro-control-wrapper">
				...
				<div class="dekanpro-checkbox-group-control">
					...
					<# _.each( data.choices, function( params, key ) { #>
						...
						<p>
							<label class="dekanpro-checkbox">
								...
								<span class="dekanpro-label">{{ params.title }}
									<# if ( params.desc ) { #>
									<i class="dekanpro-info-icon">
										<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-help-circle">
											<circle cx="12" cy="12" r="10"></circle>
										...
										<span class="dekanpro-tooltip">{{ params.desc }}</span>
									</i>
									<# } #>
								</span>
							</label>
			...
			</div><!-- END .dekanpro-button-wrapper -->
			<?php
		}
