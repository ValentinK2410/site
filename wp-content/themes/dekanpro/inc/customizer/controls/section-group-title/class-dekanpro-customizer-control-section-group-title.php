...
class Dekanpro_Customizer_Control_Section_Group_Title extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'dekanpro-section-group-title';
	...
	/**
	 * Dekanpro_Customizer_Control_Section_Group_Title constructor.
	 *
	...
	protected function render_template() { ?>
		<li id="accordion-section-{{ data.id }}" class="accordion-section <# if (data.kind==='divider') { #> dekanpro-group-divider <# } else if (data.kind==='option') { #> dekanpro-option-title <# } else { #> dekanpro-group-title <# } #>">
