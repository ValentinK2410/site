 ...
 * @access public
 */
class Dekanpro_Customizer_Control_Generic_Notice extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'dekanpro-generic-notice';
	...
	/**
	 * Dekanpro_Hiding_Section constructor.
	 *
	...
	public function enqueue() {
		 Dekanpro_Customizer_Plugin_Install_Helper::instance()->enqueue_scripts();
	}
	...
	protected function render_template() {
		...
		<li id="accordion-section-{{ data.id }}"
				class="dekanpro-notice accordion-section control-section control-section-{{ data.type }} cannot-expand">
	...
	public function create_plugin_install_button( $slug, $settings = array() ) {
		return Dekanpro_Customizer_Plugin_Install_Helper::instance()->get_button_html( $slug, $settings );
	}
}
