...
if ( ! class_exists( 'Dekanpro_Customizer_Control' ) ) :
	/**
	 * Dekanpro Customizer custom control class. To be extended in other controls.
	 */
	class Dekanpro_Customizer_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			if ( isset( $args['responsive'] ) && true === $args['responsive'] ) {
				$this->responsive = apply_filters(
					'dekanpro_customizer_responsive_breakpoints',
					array(
						'desktop' => array(
		...
		protected function responsive_devices() {
			?>
			<ul class="dekanpro-responsive-switchers">
		...
		public static function template_units() {
			?>
			<script type="text/template" id="tmpl-dekanpro-control-unit">
