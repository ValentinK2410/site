...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Range' ) ) :
	/**
	 * Dekanpro Customizer custom heading control class.
	 */
	class Dekanpro_Customizer_Control_Range extends Dekanpro_Customizer_Control {
		...
		public function enqueue() {
			parent::enqueue();
			$base_font_size = dekanpro()->options->get( 'dekanpro_html_base_font_size' );
		...
		protected function content_template() {
			?>
			<div class="dekanpro-range-wrapper dekanpro-control-wrapper">
				...
				<div class="dekanpro-control-wrap" data-unit="{{ data.value['unit'] }}">
