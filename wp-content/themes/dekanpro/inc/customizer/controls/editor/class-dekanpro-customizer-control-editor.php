...
/**
 * Dekanpro Customizer editor control class.
 */
class Dekanpro_Customizer_Control_Editor extends Dekanpro_Customizer_Control {
	/**
	...
	protected function content_template() {
		?>
		<div class="dekanpro-control-wrapper wp-js-editor dekanpro-textarea-wrapper">
			<label>
				<# if ( data.label ) { #>
