...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Button' ) ) :
	/**
	 * Dekanpro Customizer custom background control class.
	 */
	class Dekanpro_Customizer_Control_Button extends Dekanpro_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="dekanpro-button-wrapper dekanpro-control-wrapper">
			...
			<# if ( data.description ) { #>
				<div class="description customize-control-description dekanpro-field">{{{ data.description }}}</div>
			<# } #>
