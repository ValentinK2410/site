;(function($) {
 	...
 	wp.customize.controlConstructor['dekanpro-design-options'] = wp.customize.Control.extend({
		...
		ready: function() {
			...
			// Range controls.
			control.container.find( '.dekanpro-range-wrapper' ).each( function() {
				var $this = $(this);
			...
			control.container.find( 'input.dekanpro-range-input' ).on( 'change keyup', function() {
			...
			control.container.on( 'change', '.dekanpro-select-wrapper', function(){
				control.update_value();
			});
			...
			// Linked button
			control.container.on( 'click', '.dekanpro-spacing-linked', function() {
			...
			// Unlinked button
			control.container.on( 'click', '.dekanpro-spacing-unlinked', function() {
