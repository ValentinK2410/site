...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Select' ) ) :
	/**
	 * Dekanpro Customizer custom select control class.
	 */
	class Dekanpro_Customizer_Control_Select extends Dekanpro_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="dekanpro-control-wrapper dekanpro-select-wrapper">
			...
			<label>
				...
				<select class="dekanpro-select-control" {{{ data.link }}}{{{ data.multiple }}}>
