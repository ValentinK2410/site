<?php
/**
 * Dekanpro Customizer custom spacing control class.
 *
 * @package     Dekanpro
 * @author      DekanPro
 * @since       1.0.0
...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Spacing' ) ) :
	/**
	 * Dekanpro Customizer custom select control class.
	 */
	class Dekanpro_Customizer_Control_Spacing extends Dekanpro_Customizer_Control {
		...
		public function to_json() {
			...
			$this->json['title']   = esc_html__( 'Link values', 'dekanpro' );
		...
		protected function content_template() {
			?>
			<div class="dekanpro-control-wrapper dekanpro-spacing-wrapper<# if ( data.responsive ) { #> dekanpro-control-responsive <# } #>">
				...
				<# if ( ! _.isEmpty( data.unit ) ) { #>
					<div class="dekanpro-control-unit">
