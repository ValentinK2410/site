<?php
/**
 * Dekanpro Customizer custom text control class.
 *
 * @package     Dekanpro
 * @author      DekanPro
 * @since       1.0.0
...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Datetime' ) ) :
	/**
	 * Dekanpro Customizer custom select control class.
	 */
	class Dekanpro_Customizer_Control_Datetime extends Dekanpro_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="dekanpro-control-wrapper dekanpro-text-wrapper">
				...
				<label>
					...
					<div class="dekanpro-info-text">{{{ data.info }}}</div>
				</label>
