<?php
/**
 * Dekanpro Customizer custom background control class.
 *
 * @package DekanPro
...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Background' ) ) :
	/**
	 * Dekanpro Customizer custom background control class.
	 */
	class Dekanpro_Customizer_Control_Background extends Dekanpro_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'dekanpro-background';
		...
		protected function content_template() {
			?>
			<div class="dekanpro-background-wrapper dekanpro-control-wrapper">

				<# if ( data.label ) { #>
					<div class="dekanpro-control-heading customize-control-title dekanpro-field">
				...
				<# if ( data.advanced ) { #>
					...
					<div class="background-image-advanced">
						...
						<div class="background-position">
							...
							<div class="dekanpro-range-wrapper">
								...
								<div class="dekanpro-control-wrap">
									...
									<input 
										...
										value="{{ data.value['background-position-x'] }}"  />
									<span class="dekanpro-range-unit">%</span>
								</div>
							</div>
