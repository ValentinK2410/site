;( function( $ ) {
	...
	wp.customize.controlConstructor['dekanpro-background'] = wp.customize.Control.extend({
		...
		ready: function() {
			...
			control.container.find( 'input[type=range]' ).on( 'mousedown', function() {
				...
				range 			= $( this );
				range_input 	= range.parent().children( '.dekanpro-range-input' );
				...
				range.mousemove( function() {
					...
					clearTimeout( dekanpro_range_input_number_timeout );

					dekanpro_range_input_number_timeout = setTimeout( function() {
