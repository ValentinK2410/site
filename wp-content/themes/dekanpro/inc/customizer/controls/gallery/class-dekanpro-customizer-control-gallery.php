 ...
 */
class Dekanpro_Customizer_Control_Gallery extends Dekanpro_Customizer_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => __( 'Select Images', 'dekanpro' ),
				'change'       => __( 'Modify Gallery', 'dekanpro' ),
				'default'      => __( 'Default', 'dekanpro' ),
				'remove'       => __( 'Remove', 'dekanpro' ),
				'placeholder'  => __( 'No images selected', 'dekanpro' ),
				'frame_title'  => __( 'Select Gallery Images', 'dekanpro' ),
				'frame_button' => __( 'Choose Images', 'dekanpro' ),
			)
		);
	}
