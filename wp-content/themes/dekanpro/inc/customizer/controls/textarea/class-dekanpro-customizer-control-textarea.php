<?php
/**
 * Dekanpro Customizer custom textarea control class.
 *
 * @package     Dekanpro
 * @author      DekanPro
 * @since       1.0.0
...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Textarea' ) ) :
	/**
	 * Dekanpro Customizer custom select control class.
	 */
	class Dekanpro_Customizer_Control_Textarea extends Dekanpro_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="dekanpro-control-wrapper dekanpro-textarea-wrapper">
