...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Toggle' ) ) :
	/**
	 * Dekanpro Customizer custom toggle control class.
	 */
	class Dekanpro_Customizer_Control_Toggle extends Dekanpro_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="dekanpro-toggle-wrapper dekanpro-control-wrapper">
				...
				<div id="input_{{ data.id }}" class="dekanpro-toggle">

					<input  type="checkbox" id="{{ data.id }}" name="{{ data.id }}" <# if ( data.value ) { #> checked="checked" <# } #>>

					<label for="{{ data.id }}">
						<span class="dekanpro-toggle-switch"></span>
					</label>
				</div><!-- END .dekanpro-toggle -->
