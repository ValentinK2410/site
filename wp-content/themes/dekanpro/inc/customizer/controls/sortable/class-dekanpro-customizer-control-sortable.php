...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Sortable' ) ) :
	/**
	 * Dekanpro Customizer custom select control class.
	 */
	class Dekanpro_Customizer_Control_Sortable extends Dekanpro_Customizer_Control {
		...
		protected function content_template() {
			?>
				<div class="dekanpro-control-wrapper dekanpro-sortable-wrapper">
					...
					<ul class="dekanpro-sortable-control">
						<# for ( key in data.value ) { #>
							<li class="dekanpro-sortable-item<# if ( _.has( data.value, key) && ! data.value[ key ] || ! _.has( data.value, key ) && _.has( data.default, key ) && ! data.default[ key ] ) { #> invisible<# } #>" data-value="{{ key }}">
								<# if ( data.sortable ) { #>
