...
if ( ! class_exists( 'Dekanpro_Customizer_Control_Alignment' ) ) :
	/**
	 * Dekanpro Customizer custom background control class.
	 */
	class Dekanpro_Customizer_Control_Alignment extends Dekanpro_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'dekanpro-alignment';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->strings = wp_parse_args(
				...
				array(
					'top-left'     => __( 'Top Left', 'dekanpro' ),
					'top'          => __( 'Top', 'dekanpro' ),
					'top-right'    => __( 'Top Right', 'dekanpro' ),
					'left'         => __( 'Left', 'dekanpro' ),
					'center'       => __( 'Center', 'dekanpro' ),
					'right'        => __( 'Right', 'dekanpro' ),
					'bottom-left'  => __( 'Bottom Left', 'dekanpro' ),
					'bottom'       => __( 'Bottom', 'dekanpro' ),
					'bottom-right' => __( 'Bottom Right', 'dekanpro' ),
				)
			);
		...
		protected function content_template() {
			?>
			<div class="dekanpro-alignment-wrapper dekanpro-control-wrapper">
				...
				<div class="dekanpro-alignment-control">

					<# if ( ! data.choices['top-left'] && ! data.choices['top'] && ! data.choices['top-right'] ) { #>
						<div class="button-group dekanpro-top">
							<label class="dekanpro-left {{{ data.choices['top-left']}}}">
							...
							<label class="dekanpro-center {{{ data.choices['top']}}}">
							...
							<label class="dekanpro-right {{{ data.choices['top-right']}}}">
					...
					<# if ( ! data.choices['left'] && ! data.choices['center'] && ! data.choices['right'] ) { #>
						<div class="button-group dekanpro-middle">
							<label class="dekanpro-left {{{ data.choices['left']}}}">
							...
							<label class="dekanpro-center {{{ data.choices['center']}}}">
							...
							<label class="dekanpro-right {{{ data.choices['right']}}}">
					...
					<# if ( ! data.choices['bottom-left'] && ! data.choices['bottom'] && ! data.choices['bottom-right'] ) { #>							
						<div class="button-group dekanpro-bottom">
							<label class="dekanpro-left {{{ data.choices['bottom-left']}}}">
							...
							<label class="dekanpro-center {{{ data.choices['bottom']}}}">
							...
							<label class="dekanpro-right {{{ data.choices['bottom-right']}}}">
