...
if ( ! class_exists( 'Dekanpro_Customizer_Widget_Search' ) ) :

	/**
	 * Dekanpro Customizer widget class
	 */
	class Dekanpro_Customizer_Widget_Search extends Dekanpro_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Search', 'dekanpro' );
			$this->description = __( 'A search form for your site.', 'dekanpro' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="dekanpro-widget-search-style">
