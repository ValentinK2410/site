...
if ( ! class_exists( 'Dekanpro_Customizer_Widget_Darkmode' ) ) :

	/**
	 * Dekanpro Customizer widget class
	 */
	class Dekanpro_Customizer_Widget_Darkmode extends Dekanpro_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Dark mode', 'dekanpro' );
			$this->description = __( 'A dark mode for your site.', 'dekanpro' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="dekanpro-widget-darkmode-style">
