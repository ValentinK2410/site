...
if ( ! class_exists( 'Dekanpro_Customizer_Widget_Button' ) ) :

	/**
	 * Dekanpro Customizer widget class
	 */
	class Dekanpro_Customizer_Widget_Button extends Dekanpro_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$args['values']['text']       = wp_kses( $args['values']['text'], dekanpro_get_allowed_html_tags() );
			...
			$this->name        = __( 'Button', 'dekanpro' );
			$this->description = __( 'A button with custom link.', 'dekanpro' );
		...
		public function form() {
			...
			<!-- Text -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-text"><?php esc_html_e( 'Text', 'dekanpro' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button Text', 'dekanpro' ); ?>"/>
			</p>

			<!-- URL -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-url"><?php esc_html_e( 'URL', 'dekanpro' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button URL', 'dekanpro' ); ?>" />
			</p>

			<!-- Target -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-target"><?php esc_html_e( 'Open link in', 'dekanpro' ); ?>:</label>
			...
			<?php if ( ! empty( $this->styles ) ) { ?>
				<!-- Styles -->
				<p class="dekanpro-widget-button-style">
			...
			<!-- Class -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-class"><?php esc_html_e( 'Additional class', 'dekanpro' ); ?>:</label>
				<input 
					type="text" 
