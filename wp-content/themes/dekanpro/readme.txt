...
= How to install Dekanpro? =

1. Log into your WordPress Dashboard and go to Appearance » Themes and click the "Add New" button.
2. Type in "Dekanpro" in the search field and press the "Enter" key on your keyboard.
3. Click the "Install" and then "Activate" button to activate DekanPro theme on your site.
