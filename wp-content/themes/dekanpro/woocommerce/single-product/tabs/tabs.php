 ...
 *
 * Dekanpro changes: added dekanpro-container wrappers and dekanpro-fw-section. Added span inside tabs a elements,
 * because of underline animation. Added .dekanpro-entry to woocommerce-Tabs-panel (only if key === 'description' ).
 *
...
if ( ! empty( $product_tabs ) ) : ?>
	...
	<div class="woocommerce-tabs dekanpro-fw-section wc-tabs-wrapper">
		...
		foreach ( $product_tabs as $key => $product_tab ) :
			$dekanpro_classes = 'description' === $key ? 'dekanpro-entry ' : '';

			$dekanpro_classes .= sprintf( 'woocommerce-Tabs-panel woocommerce-Tabs-panel--%s', esc_attr( $key ) );
			?>
